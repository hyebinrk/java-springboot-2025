...
import com.ysrk.spring03.Car; // 같은 패키지 내의 클래스는 import할 필요가 없음
...
public class Spring03Application {
	...
	// 다른 클래스는 상관이 없음
	// 정적 메서드는 클래스 인스턴스 생성없이(new없이) 바로 호출할 수 있음
	public static void main(String[] args) {
		...
		System.out.println("75는 짝수입니까?" + isEven(75));
	...
	public void printHello() {
		System.out.println("Hello, Spriung");
	}
